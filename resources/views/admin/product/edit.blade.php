                                    ...
                                    <fieldset class="content-group">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" cols="5" class="form-control summernote"
                                                ...
                                                placeholder="Default textarea">{{old('title.'.$lang->name,$data->getTranslation('title',$lang->name))}}</textarea>
                                            <span
                                                class="text-danger">@error('title.'.$lang->name){{'Title sahəsi boş ola bilməz!'}}@enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Haqqinda</label>
                                            <textarea rows="5" cols="5" class="form-control summernote"
                                                name="about[{{$lang->name}}]"
                                                placeholder="Default textarea">{{old('about.'.$lang->name,$data->getTranslation('about',$lang->name))}}</textarea>
                                            <span
                                                class="text-danger">@error('about.'.$lang->name){{'Haqqinda sahəsi boş ola bilməz!'}}@enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label>Tesfir</label>
                                            <textarea rows="5" cols="5" class="form-control summernote"
                                                name="description[{{$lang->name}}]"
                                                placeholder="Default textarea">{{old('description.'.$lang->name,$data->getTranslation('description',$lang->name))}}</textarea>
                                            <span
                                                class="text-danger">@error('description.'.$lang->name){{'Tesfir sahəsi boş ola bilməz!'}}@enderror</span>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <span
                            class="text-danger">@error('old_price'){{'Evvelki qiymet sahəsi boş ola bilməz!'}}@enderror</span>
                    </div>
                    <div class="form-group">
                        <label>Brand</label>
