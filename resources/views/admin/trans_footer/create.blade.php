...
<div class="content">
    ...
    <!-- Basic tabs -->
    <form action="{{route('trans_footer.store')}}" method="POST" class="row" enctype="multipart/form-data">
        @csrf
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="information[{{$lang->name}}]"
                                                    placeholder="INFORMATION" value="{{old('information.'.$lang->name)}}">
                                                <span
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="extras[{{$lang->name}}]"
                                                    placeholder="EXTRAS" value="{{old('extras.'.$lang->name)}}">
                                                <span
