...
@section('content')
    <div class="content">
        ...
        <!-- Basic tabs -->
        <form action="{{route('trans_content.update',$data->id)}}" method="POST" class="row" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="col-md-10">
                <div class="card">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{old('feature_products.'.$lang->name,$data->getTranslation('feature_products',$lang->name))}}">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="new_arrivals[{{$lang->name}}]"
                                                               placeholder="New arrivals" value="{{old('new_arrivals.'.$lang->name,$data->getTranslation('new_arrivals',$lang->name))}}">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="most_view_products[{{$lang->name}}]"
                                                               placeholder="Mostview products" value="{{old('most_view_products.'.$lang->name,$data->getTranslation('most_view_products',$lang->name))}}">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="special_offer[{{$lang->name}}]"
                                                               placeholder="Special offer" value="{{old('special_offer.'.$lang->name,$data->getTranslation('special_offer',$lang->name))}}">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{old('arts_photography.'.$lang->name,$data->getTranslation('arts_photography',$lang->name))}}">
                                                        <span
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{old('childrens_books.'.$lang->name,$data->getTranslation('childrens_books',$lang->name))}}">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{old('biographies.'.$lang->name,$data->getTranslation('biographies',$lang->name))}}">
                                                        <span
