                                ...
                                <div class="card-body">
                                    <fieldset class="content-group">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="login[{{$lang->name}}]"
                                                    placeholder="Login"
                                                    value="{{old('login.'.$lang->name,$data->getTranslation('login',$lang->name))}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="or[{{$lang->name}}]"
                                                    placeholder="Or"
                                                    value="{{old('or.'.$lang->name,$data->getTranslation('or',$lang->name))}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="register[{{$lang->name}}]"
                                                    ...
                                                    value="{{old('register.'.$lang->name,$data->getTranslation('register',$lang->name))}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label>Home</label>
                                                <input type="text" class="form-control" name="home[{{$lang->name}}]"
                                                    placeholder="Home"
                                            ...
                                            <div class="form-group">
                                                <label>Shop</label>
                                                <input type="text" class="form-control" name="shop[{{$lang->name}}]"
                                                    placeholder="Shop"
                                            ...
                                            <div class="form-group">
                                                <label>Contact</label>
                                                <input type="text" class="form-control" name="contact[{{$lang->name}}]"
                                                    placeholder="Contact"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="email[{{$lang->name}}]"
                                                    placeholder="Email"
                                                    value="{{old('email.'.$lang->name,$data->getTranslation('email',$lang->name))}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    name="newsletter_subscribe[{{$lang->name}}]"
