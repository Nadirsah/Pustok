...
@section('content')
    <div class="content">
        ...
        <!-- Basic tabs -->
        <form action="{{route('slide.store')}}" method="POST" class="row" enctype="multipart/form-data">
            @csrf
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                             ...
                             <div class="card">
                                 <div class="card-body">
                                     <fieldset class="content-group">
                                         ...
                                         <div class="form-group">
                                             <label >Name</label>
                                             <textarea rows="5" cols="5" class="form-control summernote"  name="name[{{$lang->name}}]" placeholder="Default textarea">{{old('name.'.$lang->name)}}</textarea>
