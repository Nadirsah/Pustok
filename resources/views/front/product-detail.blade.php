              ...
              "asNavFor": ".product-slider-nav"
                    ...
                    >
                        <div class="single-slide">
                            <img
                                src="{{asset('front')}}/assets/image/products/product-details-1.jpg"
                                alt=""
                            />
                        </div>
                        <div class="single-slide">
                            <img
                                src="{{asset('front')}}/assets/image/products/product-details-2.jpg"
                                alt=""
                            />
                        </div>
                        <div class="single-slide">
                            <img
                                src="{{asset('front')}}/assets/image/products/product-details-3.jpg"
                                alt=""
                            />
                        </div>
                        <div class="single-slide">
                            <img
                                src="{{asset('front')}}/assets/image/products/product-details-4.jpg"
                                alt=""
                            />
                        </div>
                        <div class="single-slide">
                            <img
                                src="{{asset('front')}}/assets/image/products/product-details-5.jpg"
                                alt=""
                            />
                        </div>
                    </div>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                                ...
                                <h3>
                                    <a href="product-details.html"
                                    >a Half Very Simple Things You To</a
                                    >
                                </h3>
                            </div>
                            <div class="product-card--body">
