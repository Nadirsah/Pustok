...
Route::group(['prefix'=>'admin','middleware'=>['auth','isAdmin']],function(){
    ...
    Route::post('/delete_slide/{id}', [SlideController::class, 'delete'])->name('slide.delete');
    ...
    Route::post('offmessage/', [Message::class, 'updateMessage'])->name('offmessage');
    ...
    Route::get('/user_message', [Message::class, 'index'])->name('user_message');
